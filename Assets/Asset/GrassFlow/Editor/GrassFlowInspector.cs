...
public class GrassFlowInspector : Editor {
    ...
    void DrawWarnings() {
        ...
        if (renderers != null && renderers.Length > 1) {
            EditorGUILayout.HelpBox("There are multiple GrassFlowRenderers in the scene!.\n" +
                "You should only use one renderer and assign all of your terrains/meshes to that single instance.\n" +
                "Not doing so will cause performance and rendering issues.", MessageType.Error);
            //if (GUILayout.Button("Dismiss")) {
    ...
    void DrawMeshSelectionUI() {
        ...
        if (EditorGUILayout.BeginFadeGroup(meshSelectionExpanded.faded)) {
            ...
            EditorGUILayout.BeginHorizontal();
            if (GUILayout.Button(new GUIContent("Add/Copy Grass Mesh",
